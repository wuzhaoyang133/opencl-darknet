...
extern cl_program createProgramWithSource(cl_context context, cl_device_id * devices, size_t device_num, const char** kernel_name, size_t kernel_num, const char* options);
