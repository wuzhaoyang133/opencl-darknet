...
#ifdef OCL
extern void forward_route_layer_ocl(const route_layer l, network_state state);
extern void backward_route_layer_ocl(const route_layer l, network_state state);
#endif
